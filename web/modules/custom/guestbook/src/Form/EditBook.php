...
/**
 * Define class for the edit form.
 */
class EditBook extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $idBook = NULL): array {
    ...
    $data = $query
      ->select('guestbook', 'ebdt')
      ->condition('ebdt.id', $idBook, '=')
      ->fields('ebdt', [
        'name',
        'email',
        'number',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($this->validateForm($form, $form_state)) {
      ...
      \Drupal::messenger()
        ->addStatus(t('Congratulations! You edited your feedback!;)'));
    }
    else {
      \Drupal::messenger()
